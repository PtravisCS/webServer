[README]
  ...
  [Wireshark]
  The Wireshark captures should be filtered already (I exported them with the filters), alas my server side capture was exported with an incorrect filter it
  seems as only the packet for the get request was exported.